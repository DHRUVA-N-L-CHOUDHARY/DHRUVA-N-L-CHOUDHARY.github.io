...
const contents = [
  "Hi, i'm Dhruva N L Choudhary!",
  "I'm currently a college student pursuing a bachelor's degree in Computer Science & Artifical Intelligence at IIIT Lucknow.",
  ...
  "In my free time, I enjoy learning about new technologies and programming languages and build website projects that can train me to be proficient in the field of app development, as well as staying up to date with the latest trends in the field."
];
