  ...
  return (
    <Section section={"contacts"}>
      <div className="flex flex-col items-center justify-between gap-y-10">
        ...
        I&apos;m looking for freelancing or employment possibilities. Please write me if you have any more requests or queries, though.
        </Text>
        <ButtonLink className="flex items-center gap-x-2" variant="primary" href="mailto:dhruva05022003@gmail.com">
